<nav class="navbar p-0 fixed-top d-flex flex-row">
    ...
    <a class="navbar-brand brand-logo-mini" href="{{ url('redirect') }}"><img src="public/image/logo.png" alt="logo" /></a>
    </div>
    ...
    <ul class="navbar-nav w-100">
        ...
        <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
            <input type="text" class="form-control" placeholder="Search products" style="background: #191c24; color: white;">
        </form>
        </li>
    </ul>
